...
function checkDateRange(segments) {
  ...
  for (var i = segments.length - 1; i >= 0; i--) {
    ...
    if (dateRange && dateRange.start) {
      ...
      console.log("GET dateRange.classId = ".concat(dateRange.classId));
      if (range) {
        ...
        try {
          for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
            ...
            if (entry.start <= start && entry.end > start || entry.start >= start && entry.start < end) {
              utils.INVALIDPLAYLIST("DATERANGE tags with the same CLASS should not overlap. entry.start=".concat(entry.start, ", entry.end=").concat(entry.end, ", start=").concat(start, ", end=").concat(end));
            }
          }
        } catch (err) {
          _iterator10.e(err);
        ...
        console.log("SET dateRange.classId = ".concat(dateRange.classId));
...
var MasterPlaylist = /*#__PURE__*/function (_Playlist) {
  ...
  function MasterPlaylist() {
    ...
    _this2 = _super2.call(this, _objectSpread(_objectSpread({}, params), {}, {
...
var MediaPlaylist = /*#__PURE__*/function (_Playlist2) {
  ...
  function MediaPlaylist() {
    ...
    _this3 = _super3.call(this, _objectSpread(_objectSpread({}, params), {}, {
